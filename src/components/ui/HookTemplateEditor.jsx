...
export default function HookTemplateEditor({ templates = [], onUpdateTemplates, highlightText, noWrapper = false, placeholders = HOOK_PLACEHOLDERS, editLabel = 'Edit hooks', actionsSlot = null }) {
